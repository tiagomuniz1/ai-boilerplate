...
- Adapter `AwsSmsAdapter` com circuit breaker (opossum) e **skip gracioso** quando `AWS_SMS_ORIGINATION_IDENTITY` não está configurado — permite subir antes do remetente do Brasil ser aprovado na AWS
